...
public class SortedResidentCacheTests : BaseTests<ISortedResidentCache>
{
    ...
    {
        _sortedResidentCache = new SortedResidentCache(_logger, new FilterManager());
    }
    ...
    { 
        ...
        _sortedResidentCache.GetAll().ToList().ShouldBeInOrder(SortDirection.Ascending, new SortedResidentCache.EntryComparer());
    }
