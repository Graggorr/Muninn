...
namespace Muninn
{
    ...
    public interface IMuninnClient
    {
        ...
        Task<MuninnResult<T>> AddAsync<T>(string key, T value, TimeSpan lifeTime, Encoding encoding, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> AddAsync<T>(string key, T value, TimeSpan lifeTime, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> AddAsync<T>(string key, T value, CancellationToken cancellationToken = default);
        ...
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> InsertAsync<T>(string key, T value, TimeSpan lifeTime, Encoding encoding, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> InsertAsync<T>(string key, T value, TimeSpan lifeTime, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> InsertAsync<T>(string key, T value, CancellationToken cancellationToken = default);
        ...
        /// <typeparam name="T">Generic type of the <paramref name="value"/></typeparam>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> UpdateAsync<T>(string key, T value, TimeSpan lifeTime, Encoding encoding, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> UpdateAsync<T>(string key, T value, TimeSpan lifeTime, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> UpdateAsync<T>(string key, T value, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> RemoveAsync<T>(string key, CancellationToken cancellationToken = default);
        ...
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult> ClearAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A specified instance to cancel operation due to timeout</param>
        /// <returns>An instance of <see cref="MuninnResult{T}"/></returns>
        Task<MuninnResult<T>> GetAsync<T>(string key, CancellationToken cancellationToken = default);
    }
}
