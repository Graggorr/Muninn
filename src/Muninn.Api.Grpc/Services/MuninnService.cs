...
public class MuninnService(ICacheManager cacheManager) : Muninn.MuninnBase
{
    private readonly ICacheManager _cacheManager = cacheManager;

    public override async Task<AddReply> AddAsync(AddRequest request, ServerCallContext context)
    {
    ...
    public override async Task<GetReply> GetAsync(GetRequest request, ServerCallContext context)
    {
    ...
    public override async Task<UpdateReply> UpdateAsync(UpdateRequest request, ServerCallContext context)
    {
        var encoding = Encoding.GetEncoding(request.EncodingName);
        var entry = new Entry(request.Key, request.Value.ToByteArray(), encoding, request.LifeTime.ToTimeSpan());
    ...
    public override async Task<DeleteReply> DeleteAsync(DeleteRequest request, ServerCallContext context)
    {
